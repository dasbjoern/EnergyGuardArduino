...
// IO ports
#define LED_PIN 2
//#define ANALOGREFPIN A1
//#define ANALOGPIN A2
#define ANALOGPIN A1
/*------------------------------------------------------*/

/*-------------------constants--------------------------*/
const double r1 = 24.0; // change to used resistor value.
const double analogConstant = 1023.0; // analog input value 0-1024
//const double voltConstant = 3.3; // arduino board voltage
const double voltConstant = 5.0; // arduino board voltage
const int wattMultiplier = 1000;
/*------------------------------------------------------*/
...
void loop() {
  ...
  current = currentCalc(analogRead(ANALOGPIN));
...
double currentCalc(double volt) {
  
  double value = 0;
  //value = ((((voltConstant - volt) * voltConstant) / analogConstant) / r1);
  value = (((analogConstant - volt) / analogConstant) / r1);
  return value;
}
